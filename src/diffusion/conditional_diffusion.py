...
class GaussianDiffusion(nn.Module):
    def __init__(
        ...
        *,
        ...
        register_buffer("loss_weight", loss_weight)  # type: ignore
    ...
    def sample(self, classes, cond_scale=6.0, rescaled_phi=0.7):
        ...
        return sample_fn(
            classes, (batch_size, channels, height, width), cond_scale, rescaled_phi
        )
    ...
    def interpolate(self, x1, x2, t=None, lam=0.5):
        ...
        for i in tqdm(
            ...
            img = self.p_sample(img, torch.full((b,), i, device=device, dtype=torch.long))  # type: ignore
